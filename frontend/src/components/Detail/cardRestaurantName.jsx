  ...
  return (
    <section className='w-[100%]  h-auto flex flex-row justify-center items-center gap-5'>
      ...
      <div className='w-1/2 flex flex-col justify-center items-start gap-2 overflow-hidden text-brownCustom'>
        ...
        <p className='flex items-center gap-x-1 font-parrafo text-sm font-light text-marronCustom'><span className='text-greenCustom2 text-lg'><IoLocationSharp /></span>{restaurant?.address}</p>
        <p className='flex items-center gap-x-1 font-parrafo text-sm font-light text-marronCustom'><span className='text-greenCustom2 text-lg'><BsTelephoneFill /></span>{restaurant?.phone}</p>
