...
const FormContactLanding = () => {
  ...
  // const mailUser = 'info.greenEats@gmail.com'
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      //       console.log('Mensaje enviado, me pondre en contacto contigo a la brevedad')
      ...
      //       console.log('Necesita activar el formulario, se le ha enviado un email con un enlace para activarlo')
      //     } else {
      ...
      //       console.log('Ups!!! algo salio mal, intentalo mas tarde')
      //     } else {
...
export default FormContactLanding
