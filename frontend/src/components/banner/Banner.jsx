...
const Banner = () => {
  return (
    <section className='banner w-screen top-0 h-[calc(100vh-110px)] flex justify-center items-center content-center'>
      <Swiper
      ...
      >
        <SwiperSlide className=' bg-greenCustom'>
          <div className='absolute top-0 left-0 w-[100%] h-[100%] flex flex-col lg:flex-row lg:items-center text-whiteCustom'>
            <section className='w-full h-1/2 lg:w-1/2 lg:h-[100%] flex flex-col justify-center items-start p-[1.5rem] gap-3 lg:gap-6'>
