function BillingDetails () {
  return (
    <div className='w-9/12 my-7  h-3/5 lg:absolute lg:top-40 lg:right-20 lg:w-2/6 lg:my-0'>
      <div>
        <h1 className='text-black font-bold text-xl mb-5'>Billing Details</h1>
      </div>
      <div className='shadow-xl rounded-md w-full h-5/6 px-5 flex flex-col justify-around'>
        <div>
        ...
        <div>
          <div className='flex flex-col w-full mx-2 h-1/6'>
            <div className='flex'>
